...
- **Źródło:** plik `data/skulskawies/data.csv`.
...
| Trening | Podział czasowy: trening do 2011-02, test od 2011-03 do 2012 |
...
- Model prognozuje miesięczną zmianę poziomu Jezioro Skulska Wieś z MAE ~2.50 cm.
