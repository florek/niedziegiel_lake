# Analiza reszt modelu klimatycznego – Jezioro Skulska Wieś
...
- **R² test (cały rok):** 0.6225. **Trend w resztach:** nieistotny (p = 0.5262).

- **Sezon zimowy** R² test: -0.0777; **sezon letni** R² test: 0.2480.
