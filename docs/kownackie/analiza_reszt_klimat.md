# Analiza reszt modelu klimatycznego – Jezioro Kownackie
...
- **R² test (cały rok):** 0.3724. **Trend w resztach:** nieistotny (p = 0.3720).

- **Sezon zimowy** R² test: -0.4237; **sezon letni** R² test: -0.1520.
