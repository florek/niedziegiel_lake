...
- **Źródło:** plik `data/suszewskie/data.csv`.
...
| Trening (od–do) | **Po drenażu:** uczony od 2011-01 do 2023-12. **Sprzed drenażu:** uczony od 1994 do 2002-12. |
...
- **Model naturalny** (sprzed drenażu): uczony na danych do 2002-12, stosowany do porównań (wykresy rozbieżności, błąd miesięczny) na okresie od 1994 do 2024.
...
W **okresie treningowym** modelu naturalnego (na lewo od pionowej linii): średnia bezwzględna rozbieżność = **14.5 cm** (103 miesięcy). Linia pionowa = koniec treningu; po prawej = prognoza poza danymi treningowymi.
...
- Model prognozuje miesięczną zmianę poziomu Jezioro Suszewskie z MAE ~7.62 cm.
