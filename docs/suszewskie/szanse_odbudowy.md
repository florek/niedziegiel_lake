# Szanse na odbudowę – Jezioro Suszewskie
...
|-------|-------------------------------------|-------------|
| Drenażowy (po zmianie reżimu) | 93.752 | +1.4 |
| Naturalny (sprzed drenażu) | 93.857 | +11.9 |

**Prognoza na koniec stycznia 2027** (model drenażowy): poziom **93.752 m n.p.m.**, czyli **wzrost o 1.4 cm** w stosunku do stanu odniesienia.

W zależności od warunków pogodowych w nadchodzącym roku prognozowana zmiana poziomu w 12 miesięcy (model drenażowy) mieści się w zakresie od **-22.1 cm** do **+52.0 cm**. Najwyższą szansę realizacji (15.8%) ma jeden z wariantów pogodowych; szczegóły wszystkich wariantów i szans – w raporcie [Prognoza 12 mies.](#docs-suszewskie-prognoza).
