...
Kolumny: **Data** (pierwszy dzień miesiąca, dd.mm.yyyy), **Poziom** [m], **Zmiana** [m] (target), **Opad** [mm], **Temperatura** [°C]. Wartości dziesiętne z przecinkiem. Wiersze z #ERROR! lub brakami są pomijane. **Limit wysokości:** w scenariuszu modelowym (ewaluacja, raporty) poziom jeziora nie może przekraczać dopuszczalnego maksimum – jeziora mają na pewnych rzędnych odpływy. Dla każdego jeziora w `MAX_POZIOM_SPIETRZANIA_BY_LAKE` ustawione jest **maks. spiętrzenie (dopuszczony stan)** na podstawie historycznego maksimum z pomiarów: Budzisławskie 99,02 m, Koziegłowskie 101,91 m, Niedzięgiel 103,80 m, Ostrowskie 98,66 m, Powidzkie 98,79 m, Skulska Wieś 86,49 m, Suszewskie 98,94 m, Wilczyńskie 99,15 m.
