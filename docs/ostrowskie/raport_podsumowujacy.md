# Raport podsumowujący: prognoza zmiany poziomu Jezioro Ostrowskie

## 1. Cel projektu

Projekt ma na celu:
- zbudowanie **modelu uczenia maszynowego**, który na podstawie opadu i temperatury (oraz sezonowości i historii) prognozuje **miesięczną zmianę poziomu** Jezioro Ostrowskie;
...
- **Źródło:** plik `data/ostrowskie/data.csv`.
...
- **Model naturalny** (sprzed drenażu): uczony na danych do 2003-12, stosowany do porównań (wykresy rozbieżności, błąd miesięczny) na okresie od 1993 do 2026.
...
W **okresie treningowym** modelu naturalnego (na lewo od pionowej linii): średnia bezwzględna rozbieżność = **3.3 cm** (129 miesięcy). Linia pionowa = koniec treningu; po prawej = prognoza poza danymi treningowymi.
...
- Model prognozuje miesięczną zmianę poziomu Jezioro Ostrowskie z MAE ~2.11 cm.
