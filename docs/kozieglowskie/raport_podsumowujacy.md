...
- Wiersze z błędami (#ERROR!) lub brakami są pomijane. Po usunięciu lagów (5 mies.) do analizy wchodzi **348** miesięcy.
...
| Trening (od–do) | **Po drenażu:** uczony od 2011-01 do 2023-12. **Sprzed drenażu:** uczony od 1995 do 2002-12. |
...
- **Model naturalny** (sprzed drenażu): uczony na danych do 2002-12, stosowany do porównań (wykresy rozbieżności, błąd miesięczny) na okresie od 1995 do 2024.
...
W **okresie treningowym** modelu naturalnego (na lewo od pionowej linii): średnia bezwzględna rozbieżność = **4.2 cm** (83 miesięcy). Linia pionowa = koniec treningu; po prawej = prognoza poza danymi treningowymi.
...
- Model prognozuje miesięczną zmianę poziomu Jezioro Koziegłowskie z MAE ~3.88 cm.
