...
- Wiersze z błędami (#ERROR!) lub brakami są pomijane. Po usunięciu lagów (5 mies.) do analizy wchodzi **358** miesięcy.
...
| Trening | Podział czasowy: trening do 2023-12, test od 2024 do 2003 |
...
- Model prognozuje miesięczną zmianę poziomu Jezioro Koziegłowskie z MAE ~nan cm.
