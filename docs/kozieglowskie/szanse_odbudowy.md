...
|-------|-------------------------------------|-------------|
| Drenażowy (po zmianie reżimu) | 101.046 | +4.3 |
| Naturalny (sprzed drenażu) | 101.193 | +19.0 |

**Prognoza na koniec stycznia 2027** (model drenażowy): poziom **101.046 m n.p.m.**, czyli **wzrost o 4.3 cm** w stosunku do stanu odniesienia.

W zależności od warunków pogodowych w nadchodzącym roku prognozowana zmiana poziomu w 12 miesięcy (model drenażowy) mieści się w zakresie od **-12.7 cm** do **+23.1 cm**. Najwyższą szansę realizacji (16.1%) ma jeden z wariantów pogodowych; szczegóły wszystkich wariantów i szans – w raporcie [Prognoza 12 mies.](#docs-kozieglowskie-prognoza).
