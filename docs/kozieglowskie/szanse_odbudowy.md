...
**Stan odniesienia:** koniec stycznia 2026 – poziom 100.680 m n.p.m.

**Porównanie prognoz** (najbardziej prawdopodobny scenariusz, średnia ważona):

| Model | Poziom koniec (m n.p.m.) | Zmiana (cm) |
|-------|-------------------------------------|-------------|
| Drenażowy (po zmianie reżimu) | 100.710 | +3.0 |
| Naturalny (sprzed drenażu) | 101.141 | +46.1 |

**Prognoza na koniec stycznia 2027** (model drenażowy): poziom **100.710 m n.p.m.**, czyli **wzrost o 3.0 cm** w stosunku do stanu odniesienia.

W zależności od warunków pogodowych w nadchodzącym roku prognozowana zmiana poziomu w 12 miesięcy (model drenażowy) mieści się w zakresie od **-10.6 cm** do **+16.0 cm**. Najwyższą szansę realizacji (16.5%) ma jeden z wariantów pogodowych; szczegóły wszystkich wariantów i szans – w raporcie [Prognoza 12 mies.](#docs-kozieglowskie-prognoza).
