# Szanse na odbudowę – Jezioro Koziegłowskie
...
**Stan odniesienia:** koniec stycznia 2026 – poziom 101.003 m n.p.m.

**Porównanie prognoz** (najbardziej prawdopodobny scenariusz, średnia ważona):

| Model | Poziom koniec (m n.p.m.) | Zmiana (cm) |
|-------|-------------------------------------|-------------|
| Drenażowy (po zmianie reżimu) | 101.050 | +4.7 |
| Naturalny (sprzed drenażu) | 101.191 | +18.8 |

**Prognoza na koniec stycznia 2027** (model drenażowy): poziom **101.050 m n.p.m.**, czyli **wzrost o 4.7 cm** w stosunku do stanu odniesienia.

W zależności od warunków pogodowych w nadchodzącym roku prognozowana zmiana poziomu w 12 miesięcy (model drenażowy) mieści się w zakresie od **-12.7 cm** do **+23.1 cm**. Najwyższą szansę realizacji (15.2%) ma jeden z wariantów pogodowych; szczegóły wszystkich wariantów i szans – w raporcie [Prognoza 12 mies.](#docs-kozieglowskie-prognoza).
...
Szacunki długoterminowej odbudowy (lata do zamknięcia luki po ewentualnym zaniku drenażu) – patrz [Zanik drenażu](#docs-kozieglowskie-zanik-drenazu).
