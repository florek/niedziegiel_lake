...
- Wiersze z błędami (#ERROR!) lub brakami są pomijane. Po usunięciu lagów (13 mies.) do analizy wchodzi **585** miesięcy.
...
| Cechy wejściowe | Miesiąc (sin/cos), Opad, Temperatura, opad i temperatura z opóźnieniem 1–13 mies., 3 opóźnienia zmiany poziomu, 3 opóźnienia poziomu |
| Trening (od–do) | **Po drenażu:** uczony od 2018-01 do 2023-12. **Sprzed drenażu:** uczony od 1977 do 2017-12. |
...
- **Model naturalny** (sprzed drenażu): uczony na danych do 2017-12, stosowany do porównań (wykresy rozbieżności, błąd miesięczny) na okresie od 1977 do 2025.
...
W **okresie treningowym** modelu naturalnego (na lewo od pionowej linii): średnia bezwzględna rozbieżność = **4.6 cm** (491 miesięcy). Linia pionowa = koniec treningu; po prawej = prognoza poza danymi treningowymi.
...
- Model prognozuje miesięczną zmianę poziomu Jezioro Niedzięgiel z MAE ~3.00 cm.
