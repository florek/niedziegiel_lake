# Analiza reszt modelu klimatycznego – Jezioro Budzisławskie
...
- **R² test (cały rok):** 0.4545. **Trend w resztach:** nieistotny (p = 0.4460).

- **Sezon zimowy** R² test: -0.1402; **sezon letni** R² test: 0.1232.

## Reszty – wariant A (cały rok)

![Analiza reszt – cały rok](reszty_wariant_A.png)

## Reszty – sezon zimowy (XI–III)

![Analiza reszt – sezon zimowy](reszty_sezon_zimowy_XI-III.png)

## Reszty – sezon letni (IV–X)

![Analiza reszt – sezon letni](reszty_sezon_letni_IV-X.png)
