# Analiza reszt modelu klimatycznego – Jezioro Powidzkie
...
- **R² test (cały rok):** 0.4358. **Trend w resztach:** nieistotny (p = 0.1407).

- **Sezon zimowy** R² test: -0.2429; **sezon letni** R² test: 0.0853.
