# Analiza reszt modelu klimatycznego – Jezioro Wilczyńskie
...
- **R² test (cały rok):** 0.1954. **Trend w resztach:** istotny (p = 0.0334).

- **Sezon zimowy** R² test: -0.7057; **sezon letni** R² test: -0.3673.
