...
**Stan odniesienia:** koniec stycznia 2026 – poziom 93.180 m n.p.m.

**Porównanie prognoz** (najbardziej prawdopodobny scenariusz, średnia ważona):

| Model | Poziom koniec (m n.p.m.) | Zmiana (cm) |
|-------|-------------------------------------|-------------|
| Drenażowy (po zmianie reżimu) | 92.927 | -25.3 |
| Naturalny (sprzed drenażu) | 93.282 | +10.2 |

**Prognoza na koniec stycznia 2027** (model drenażowy): poziom **92.927 m n.p.m.**, czyli **spadek o 25.3 cm** w stosunku do stanu odniesienia.

W zależności od warunków pogodowych w nadchodzącym roku prognozowana zmiana poziomu w 12 miesięcy (model drenażowy) mieści się w zakresie od **-58.5 cm** do **+21.2 cm**. Najwyższą szansę realizacji (16.8%) ma jeden z wariantów pogodowych; szczegóły wszystkich wariantów i szans – w raporcie [Prognoza 12 mies.](#docs-wilczynskie-prognoza).
