...
- Wiersze z błędami (#ERROR!) lub brakami są pomijane. Po usunięciu lagów (3 mies.) do analizy wchodzi **381** miesięcy.
...
| Trening (od–do) | **Po drenażu:** uczony od 2015-01 do 2023-12. **Sprzed drenażu:** uczony od 1993 do 2002-12. |
...
W **okresie treningowym** modelu naturalnego (na lewo od pionowej linii): średnia bezwzględna rozbieżność = **9.4 cm** (119 miesięcy). Linia pionowa = koniec treningu; po prawej = prognoza poza danymi treningowymi.
...
- Model prognozuje miesięczną zmianę poziomu Jezioro Wilczyńskie z MAE ~4.41 cm.
